...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_UIActions p_UIActions;
        ...
        public static SteamVR_Input_ActionSet_UIActions UIActions
        {
            get
            {
                return SteamVR_Actions.p_UIActions.GetCopy<SteamVR_Input_ActionSet_UIActions>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_UIActions = ((SteamVR_Input_ActionSet_UIActions)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_UIActions>("/actions/UIActions")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.UIActions};
        }
    }
}
